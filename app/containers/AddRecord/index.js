...
import makeSelectAddRecord from './selectors';
...
export class AddRecord extends React.Component { // eslint-disable-line react/prefer-stateless-function
  constructor(props){
      super(props);
      this.state={
          isAlert:false,
